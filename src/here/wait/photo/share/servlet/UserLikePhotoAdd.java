...
public class UserLikePhotoAdd extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public UserLikePhotoAdd()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		result = ((UserLikePhotoService)AppliationContextUtility.getBean("userLikePhotoService")).add(userId, photoId);
