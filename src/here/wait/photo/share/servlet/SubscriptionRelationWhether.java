...
public class SubscriptionRelationWhether extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public SubscriptionRelationWhether()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		String result = ((SubscriptionRelationService)AppliationContextUtility.getBean("subscriptionRelationService")).isSubscriptionRelation(userId, subscriptionId);
