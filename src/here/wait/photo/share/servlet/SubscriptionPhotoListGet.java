...
public class SubscriptionPhotoListGet extends HttpServlet
{

	public SubscriptionPhotoListGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		String result = ((PhotoService)AppliationContextUtility.getBean("photoService")).getSubscriptionPhotoList(userId, pageIndex, pageSize);
