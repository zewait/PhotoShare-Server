...
public class UserSearchByName extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		if (null != pageIndexStr && pageIndexStr.length() > 0)
		...
		String result = ((UserService) AppliationContextUtility
				.getBean("userService")).search(name, pageIndex, pageSize);
