...
public class PhotoCountGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public PhotoCountGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		String result = ((PhotoService)AppliationContextUtility.getBean("photoService")).getCount(userId);
