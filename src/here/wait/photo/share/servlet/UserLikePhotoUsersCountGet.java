...
public class UserLikePhotoUsersCountGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public UserLikePhotoUsersCountGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		result = ((UserLikePhotoService)AppliationContextUtility.getBean("userLikePhotoService")).getUserCount(photoId);
