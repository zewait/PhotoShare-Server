...
public class UserLikePhotoDelete extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public UserLikePhotoDelete()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		result = ((UserLikePhotoService)AppliationContextUtility.getBean("userLikePhotoService")).delete(userId, photoId);
