...
public class UserLikePhotoPhotoCountGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public UserLikePhotoPhotoCountGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		result = ((UserLikePhotoService)AppliationContextUtility.getBean("userLikePhotoService")).getPhotoCount(userId);
		DebugUtility.p("result " + result);
		out.print(result);
