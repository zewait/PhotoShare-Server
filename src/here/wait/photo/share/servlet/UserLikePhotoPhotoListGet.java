...
public class UserLikePhotoPhotoListGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public UserLikePhotoPhotoListGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		result = ((UserLikePhotoService)AppliationContextUtility.getBean("userLikePhotoService")).getPhotoList(userId, pageIndex, pageSize);
