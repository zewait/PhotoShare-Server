...
public class FanRelationCountGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public FanRelationCountGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		String result = ((FanRelationService)AppliationContextUtility.getBean("fanRelationService")).getFanRelationCount(userId);
