...
public class PhotoBlowRandomGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public PhotoBlowRandomGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		String result = ((PhotoService)AppliationContextUtility.getBean("photoService")).getRandomBlowPhoto();
