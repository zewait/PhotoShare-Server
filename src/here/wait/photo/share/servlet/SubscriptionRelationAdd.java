...
public class SubscriptionRelationAdd extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public SubscriptionRelationAdd()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		SubscriptionRelationService service = (SubscriptionRelationService)AppliationContextUtility.getBean("subscriptionRelationService");
		String result = service.addSubscriptionRelation(myId, subscriptionId);
