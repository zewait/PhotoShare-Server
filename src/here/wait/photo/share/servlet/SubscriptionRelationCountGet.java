...
public class SubscriptionRelationCountGet extends HttpServlet
{

	/**
	 * Constructor of the object.
	 */
	public SubscriptionRelationCountGet()
	{
		super();
	}
			...
			throws ServletException, IOException
	{
		...
		String result = ((SubscriptionRelationService)AppliationContextUtility.getBean("subscriptionRelationService")).getSubscriptionRelationCount(userId);
